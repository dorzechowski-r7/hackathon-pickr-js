...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PickrApp = __webpack_require__(4);

	var _PickrApp2 = _interopRequireDefault(_PickrApp);
	...
	app.render();
	(0, _jquery2.default)("#app").empty().append(app.el);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PickrView2 = __webpack_require__(5);

	var _PickrView3 = _interopRequireDefault(_PickrView2);
	...
	var PickrApp = function (_PickrView) {
	    _inherits(PickrApp, _PickrView);

	    function PickrApp() {
	        _classCallCheck(this, PickrApp);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(PickrApp).call(this));

	        _this.className = "main-view";
	        _this.template = "templates/main.html";
	        return _this;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PickrView = function (_Backbone$View) {
	    _inherits(PickrView, _Backbone$View);

	    function PickrView() {
	        _classCallCheck(this, PickrView);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(PickrView).call(this));

	        _this.render = _lodash2.default.bind(_this.render, _this);
	        return _this;
	    }

	    _createClass(PickrView, [{
	        key: "render",
	        value: function render() {
	            var _this2 = this;

	            var renderFn = function renderFn() {
	                _this2.$el.html(_this2.templateFn({
	                    model: _this2.model
	                }));
	            };
	            ...
	            if (this.templateFn) {
	                ...
	                $.get(this.template).done(function (templateData) {
	                    _this2.templateFn = _lodash2.default.template(templateData);
	                    renderFn();
	                });
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(7)(module), (function() { return this; }()), __webpack_require__(6)))
